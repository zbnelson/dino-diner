/*  MenuItemDescriptionTest.cs
*   Author: Nathan Bean
*   Modified by: Zachary Nelson
*/
using System;
...
namespace MenuTest
{
    public class MenuItemDescriptionTest
    {
        #region Entrees
        ...
        public void ToStringShouldGiveDescription(Type type, string Description)
        {
